        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/mike2.JPG)'}} />
              <h1 id="colorlib-logo"><a href="index.html">Mike Nsubuga</a></h1>
              <span className="email"><i className="icon-mail"></i> nsubugamike021@gmail.com</span>
            </div>
